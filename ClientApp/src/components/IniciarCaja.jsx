...
export class IniciarCaja extends Component {
    state = {
                                ...
                                <tr key={cajero.id_cajero}>
                                    ...
                                    <td>
                                        ...
                                        <Link to="/cajaCajeros" className="custom-link">
                                            <button type="button" className="btn btn-outline-warning" onClick={this.addCajero}>Abrir</button>
                                        </Link>
                                        <button type="button" className="btn btn-outline-danger" onClick={() => this.deleteCajero(cajero.id_cajero)}>
                    ...
                    <ModalFooter>
                        <Link to='/cajaCajeros' className="custom-link">
                            <div className="d-grid gap-2">
                                <button type="button" className="btn btn-warning" onClick={this.addCajero}>Abrir</button>
                            </div>
                        </Link>
